...
# DATA_DIRECTORY = '/home/user/nilm/data/low_freq'
DATA_DIRECTORY = '/mnt/user/nilm/data/low_freq'   #without last /
# SAVE_PATH = '/mnt/user/seq2point-nilm/data/REDD123/'
SAVE_PATH = '/mnt/user/seq2point-nilm/experiments/exp210304/data/REDD/'
